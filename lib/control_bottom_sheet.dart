...
class ControlBottomSheet extends StatefulWidget {
  final  int index;
  ControlBottomSheet(this.index);
  //  List<String> formValue;
  // ControlBottomSheet(this.formValue);

  @override
  _ControlBottomSheetState createState() => _ControlBottomSheetState();
}
            ...
            child: Column(
              children: [
                FormField<List<String>>(
                  autovalidate: true,
                  initialValue: widget.index>-1?controlProvider.getNewSelectedItems:controlProvider.getSelectValue,
                  onSaved: (val) =>
                      setState(() =>widget.index>-1?controlProvider.editNewItems(val): controlProvider.setSelectedValue(val)),
                  validator: (value) {
                    ...
                    return Column(
                      children: <Widget>[
                        ...
                        Container(
                            ...
                            child: Text(
                              state.errorText ??
                                  state.value.length.toString() + '/${options.length} selected',
                              style: TextStyle(
                    ...
                    children: [
                      Expanded(
                        child: Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(height: 5),
                              Text(
                                  '${controlProvider.getSelectValue.toString()}')
                            ]),
                      ),
                      SizedBox(
                        width: 5,
                      ...
                      RaisedButton(
                          ...
                          onPressed: () {
                            ...
                            print(
                                'get val ${(controlProvider.getSelectValue).toString()}');
